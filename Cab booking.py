...
class Login:
    def __init__(self,root):
        ...
        self.canvas=Canvas(self.root,bg="pink",height=250, width=300).place(x=180,y=120)
        ...
        self.asking=Label(self.root,text="You have a account?",font="Helvetica 8 bold").place(x=210,y=330)
        self.signup_button=Button(self.root,text="Sign Up",font="Helvetica 9 bold",bg="blue",command=self.rg_page).place(x=330,y=330)
    ...
    def login_access1(self):
        ...
        if (self.Login_name == "sunil" and self.Login_pass == "password"):
...
class admin_page:
    ...
    def __init__(self,top1):
        ...
        self.canvas_admin = Canvas(self.top1, bg="purple", height=250, width=300).place(x=180, y=120)
        self.admin2 = Label(self.top1, text="Costumer Detail", font="Helvetica 10 bold").place(x=200, y=150)
        self.admin_button=Button(self.top1,text="Click Here",bg='orange',font="Helvetica 9 bold",command=self.costumer_detail).place(x=400,y=150)
        self.admin2 = Label(self.top1, text="Costumer Booking", font="Helvetica 10 bold").place(x=200, y=200)
        self.admin_button1 = Button(self.top1, text="Click Here", bg='orange', font="Helvetica 9 bold",command=self.costumer_booking).place(x=400, y=200)
        self.logout_button = Button(self.top1, text="Log Out", font="Helvetica 9 bold", bg="blue",command=self.login).place(x=330, y=330)
        self.top1.mainloop()
    def login(self):
        Login(self.top1)
